...
function imgfading(speed) {
 ...
 // $('ul.imgfading').append('<li id="imgfading-caption" class="caption"><div class="imgfading-caption-container"><p></p></div></li>');
 ...
 // $('#imgfading-caption p').html($('ul.imgfading li.show').find('img').attr('alt'));
    
  // display the caption
 // $('#imgfading-caption').css({opacity: 1, bottom:0});
